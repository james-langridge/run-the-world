  ...
  return (
    <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg shadow p-8">
      <div className="flex items-start gap-4">
        <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-orange-600 flex-shrink-0 mt-1"></div>
        <div className="flex-1">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
            Due to Strava rate limits, large syncs may take several hours. Your data will appear below as it&apos;s imported.
          </p>
          <button
